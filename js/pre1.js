var pre1State = {
	...
	preload: function(){
		// load menu images
		game.load.spritesheet('dialogue', 'assets/lv1_intro.png', 257, 165, 18);
		game.load.spritesheet('player', 'assets/art/default/protag_spritesheet.png', 37, 65);
		game.load.spritesheet('sky', 'assets/art/default/sky_spritesheet.png', 1920, 1080, 2);
		game.load.spritesheet('hgrass', 'assets/art/default/grass_h_spritesheet.png', 252, 48, 2);
