var pre2State = {
	...
	preload: function(){
		...
		game.load.spritesheet('sky', 'assets/art/default/ice/ice_bg_spritesheet.png', 1000, 800, 2);
		game.load.spritesheet('hgrass', 'assets/art/default/ice/ice_h_spritesheet.png', 252, 48, 2);
